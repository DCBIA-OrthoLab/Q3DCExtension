...
class Measure:
  ...
  def isUpperLower(self,landmark):
    ...
    List = ['LL7','LL6','LL5','LL4','LL3','LL2','LL1','LR1','LR2','LR3','LR4','LR5','LR6','LR7','UL7','UL6','UL5','UL4','UL3','UL2','UL1','UR1','UR2','UR3','UR4','UR5','UR6','UR7']
    loop = 1
...
class Distance(Measure) :
  ...
  def SignManager(self):
    if self.measure == 'Distance between 2 points':
      if self.isUpperLower(self.point1["name"]) and self.isUpperLower(self.point2line["name"]):
